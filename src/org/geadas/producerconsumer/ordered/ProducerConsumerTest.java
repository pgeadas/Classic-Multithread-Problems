 ...
 */
package org.geadas.producerconsumer.ordered;
...
public class ProducerConsumerTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Ordered Producer/Consumer test ended.");
    }
}
...
class ProductQueue {
    ...
    volatile int i = 0;
    volatile int expectedOperation = 1;
    volatile int currentOperation = 1;
    ...
    public synchronized boolean put(int value, int workerNumber, int currentOperation) throws InterruptedException {
        ...
        while (currentOperation != expectedOperation) { //if the operation is not the expected
            System.out.println("Producer #: " + workerNumber + " tried to insert: " + value);
            wait(500);
        }
...
class Producer extends Thread {
    ...
    public void run() {
        for (int i = 0; i < 10; i++) {
            ...
            try {
                prodQueue.put(prodQueue.i++, this.number, prodQueue.currentOperation++);
            } catch (InterruptedException e) {
               System.out.println("Got interrupted: " + e.getMessage());
            }
        }
